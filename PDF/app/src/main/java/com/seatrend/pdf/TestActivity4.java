...
/**
 * Created by hdy on 2020/10/19 16:04
 */
public class TestActivity4 extends AppCompatActivity {
    ...
    private void setup() {
        ...
        if (ContextCompat.checkSelfPermission(TestActivity4.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(TestActivity4.this,
    ...
    public void createPdf(View v) {
        ...
        try {
            ...
            font = PDType0Font.load(document, assetManager.open("simsunb.ttf"));
        } catch (IOException e) {
    ...
    public void fillForm(View v) {
        try {
            ...
            PDDocument document = PDDocument.load(assetManager.open("BS_report_Temp.pdf"));
...
//            ((PDComboBox) dropdown).setValue("Hello");
            ...
            // Or use LiberationSans "com/tom_roush/pdfbox/resources/ttf/LiberationSans-Regular.ttf"
//            font = PDType0Font.load(document, assetManager.open("simsunb.ttf"));
            font = PDType0Font.load(document, assetManager.open("R-PMingLiU-TW-2.ttf"));
            ...
            // Define a content stream for adding to the PDF
            contentStream = new PDPageContentStream(document, document.getPage(0), true, true);
            showLog("文本叠加流创建成功");
            // Write Hello World in blue text
            contentStream.beginText();
            contentStream.setNonStrokingColor(15, 38, 192);
